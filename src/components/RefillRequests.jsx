    ...
    const filteredRequests =
        filter === "ALL"
            ...
            : refillRequests.filter((req) => {
                  ...
                  if (filter === "CONFIRMED") {
                      return ["CONFIRMED", "OUT_FOR_DELIVERY"].includes(
                          req.status
                      );
                  }
                  return true;
    ...
    if (!shop) {
        return (
            <div style={styles.container}>
                ...
                <p>
                    You need to create a shop first to receive refill requests.
                </p>
            </div>
        );
    }
                ...
                <div style={styles.filters}>
                    ...
                    >
                        ...
                        <option value="CONFIRMED">
                            Active (
                            {
                                refillRequests.filter((r) =>
                                    ["CONFIRMED", "OUT_FOR_DELIVERY"].includes(
                                        r.status
                                    )
                                ).length
                            }
                    ...
                    <button
                        onClick={findShopAndLoadRequests}
                ...
                <div style={styles.emptyState}>
                    {filter === "PENDING" ? (
                        <>
                            ...
                            <p>
                                New requests will appear here when customers
                                need refills.
                            </p>
                        </>
                    ) : (
                                ...
                                {request.status === "REFILL_REQUESTED" && (
                                    <div style={styles.actionButtons}>
                                        ...
                                        <button
                                            onClick={() => {
                                                const phone = prompt(
                                                    "Customer phone number for confirmation:"
                                                );
                                                if (phone) {
                                                    console.log(
                                                        `Call customer at ${phone} for ${request.productName}`
                                                    );
                                                    alert(
                                                        `📞 Please call ${request.userId.name} at ${phone} to confirm delivery`
                                                    );
                                                }
                                            }}
