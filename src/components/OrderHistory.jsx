  ...
  const loadOrderHistory = async () => {
    try {
      ...
      const userOrders = res.data.filter(order => 
        ...
        (typeof order.customerId === 'object' && order.customerId._id === user._id)
      );
    ...
    try {
      ...
      for (const item of order.items) {
        ...
        if (existingItem) {
          ...
          const product = productRes.data.find(p => p._id === item.productId._id);
      ...
      alert('Items added to cart! You can modify quantities before placing order.');
    } catch (err) {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.filters}>
          ...
          <button onClick={loadOrderHistory} style={styles.refreshButton}>
            🔄 Refresh
          </button>
        </div>
      </div>
